...
def add_class_as_grp(obj,grpParent,compress=False,overwrite=True):
    '''
    ...
    for attr in dictname:
        ...
        if isinstance(value,Output) or isinstance(value,TimeHistory):
...
class Output(RootClass):
    ...
    def __init__(self,name=None):
        ...
        self.name=name
        self.strategy=None
        self.CumSeriesSR=None
        self.AvgAbsVal=None
        self.ForecastScalar=None
        self.turnover=None
        self.Years=None
...
class TimeHistory(RootClass):
    '''
    Contains row data from csv. Can be either allocated once for each product, 
    or once for each product/model (if different input forr different models are
    employed)
    '''

    def __init__(self,name=None):
        self.start_date=None
        self.px_close=None      # ewma/stoch/break
        self.px_low=None        # stoch
        self.px_high=None       # stoch
        self.st_dev=None        # all
        self.near=None          # carry
        self.far=None           # carry
