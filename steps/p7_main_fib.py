...
#     "date": pd.to_datetime([        "04/01/1993", "05/01/1993", "06/01/1993", "07/01/1993", "08/01/1993",        "11/01/1993", "12/01/1993", "13/01/1993", "14/01/1993", "15/01/1993",        "18/01/1993", "19/01/1993", "20/01/1993", "21/01/1993", "22/01/1993",        "25/01/1993", "26/01/1993", "27/01/1993", "28/01/1993", "29/01/1993",        "01/02/1993", "02/02/1993", "03/02/1993", "04/02/1993", "05/02/1993",        "08/02/1993", "09/02/1993", "10/02/1993", "11/02/1993", "12/02/1993",        "15/02/1993", "16/02/1993", "17/02/1993", "18/02/1993", "19/02/1993",        "22/02/1993", "23/02/1993", "24/02/1993", "25/02/1993", "26/02/1993",        "01/03/1993", "02/03/1993", "03/03/1993", "04/03/1993", "05/03/1993",        "08/03/1993", "09/03/1993", "10/03/1993", "11/03/1993"
#     ], format="%d/%m/%Y"),
...
filename = "CN1"
csv_data = pd.read_csv(rf"C:\Users\loci_\Desktop\trading_webapp\DATA\input_instruments\{filename}.csv")

collected_df = csv_data[['Date','PX_CLOSE_1D','PX_HIGH','PX_LOW']].copy() # loading
daily_df = pd.DataFrame([],columns=['date','close','high','low']) # collection
daily_df['date'] = pd.to_datetime(collected_df['Date'], format="%d/%m/%Y") # date conversion
daily_df['close'] = collected_df['PX_CLOSE_1D'].copy()
daily_df['high'] = collected_df['PX_HIGH'].copy()
daily_df['low'] = collected_df['PX_LOW'].copy()
...
out_xlsx = f"daily_analysis_combined_{filename}.xlsx"
...
fib_result_df_full["pnl_sharp_ratio_value"] = all_pnls.mean() / all_pnls.std() * 16  # annualized
