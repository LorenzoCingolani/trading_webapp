# Create a reusable Python script that computes 25-delta Risk Reversal (RR) for any stock or index via IBKR.
# It narrows down to the 25Δ call/put using a rough BS guess first (to minimize IB data requests),
# then pulls snapshot market data for the two selected options to compute both price- and vol-based RR.
# Save as /mnt/data/risk_reversal_ib.py
...
if __name__ == "__main__":
    ...
    main()
'''
# Save locally instead of /mnt/data/, using UTF-8 encoding
with open('C:/Users/loci_/Desktop/trading_webapp/strategies_mine/risk_reversal_ib.py', 'w', encoding='utf-8') as f:
    f.write(script)

print("Saved to C:/Users/loci_/Desktop/trading_webapp/strategies_mine/risk_reversal_ib.py")
